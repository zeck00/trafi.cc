...
export const platforms: Platform[] = [
  // ═══ Social ═══
  {
    id: "facebook", name: "Facebook", category: "social", logo: "📘",
  ...
  {
    id: "instagram", name: "Instagram", category: "social", logo: "📷",
  ...
  {
    id: "tiktok", name: "TikTok", category: "social", logo: "🎵",
  ...
  {
    id: "youtube", name: "YouTube", category: "social", logo: "▶️",
  ...
  {
    id: "x", name: "X / Twitter", category: "social", logo: "𝕏",
  ...
  {
    id: "snapchat", name: "Snapchat", category: "social", logo: "👻",
  ...
  {
    id: "reddit", name: "Reddit", category: "social", logo: "🤖",
  ...
  {
    id: "pinterest", name: "Pinterest", category: "social", logo: "📌",
  ...
  {
    id: "threads", name: "Threads", category: "social", logo: "🧵",
  ...
  {
    id: "twitch", name: "Twitch", category: "social", logo: "🟣",
  ...
  {
    id: "bereal", name: "BeReal", category: "social", logo: "📸",
  ...
  {
    id: "discord", name: "Discord", category: "messaging", logo: "🎮",
  ...
  {
    id: "wechat", name: "WeChat", category: "messaging", logo: "🟢",
  ...
  {
    id: "line", name: "LINE", category: "messaging", logo: "🟩",
  ...
  {
    id: "messenger", name: "Messenger", category: "messaging", logo: "💙",
  ...
  // ═══ Shopping ═══
  {
    id: "amazon", name: "Amazon", category: "shopping", logo: "📦",
  ...
  {
    id: "temu", name: "Temu", category: "shopping", logo: "🛍️",
  ...
  {
    id: "shein", name: "Shein", category: "shopping", logo: "👗",
    arpu: { na: 12.0, eu: 6.0, apac: 2.5, latam: 1.8, mena: 1.5, row: 1.0 },
    dataTypes: [{ type: "purchase_intent", weight: 0.55 }, { type: "browsing", weight: 0.3 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "ebay", name: "eBay", category: "shopping", logo: "🏷️",
    arpu: { na: 18.0, eu: 10.0, apac: 2.0, latam: 1.0, mena: 0.8, row: 0.6 },
    dataTypes: [{ type: "purchase_intent", weight: 0.55 }, { type: "browsing", weight: 0.3 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "aliexpress", name: "AliExpress", category: "shopping", logo: "🛒",
    arpu: { na: 5.0, eu: 4.0, apac: 3.0, latam: 2.0, mena: 2.5, row: 1.5 },
    dataTypes: [{ type: "purchase_intent", weight: 0.6 }, { type: "browsing", weight: 0.25 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "etsy", name: "Etsy", category: "shopping", logo: "🧶",
    arpu: { na: 14.0, eu: 6.0, apac: 1.0, latam: 0.5, mena: 0.4, row: 0.3 },
    dataTypes: [{ type: "purchase_intent", weight: 0.6 }, { type: "browsing", weight: 0.25 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "mercadolibre", name: "Mercado Libre", category: "shopping", logo: "🤝",
    arpu: { na: 2.0, eu: 0.5, apac: 0.3, latam: 12.0, mena: 0.3, row: 0.2 },
    dataTypes: [{ type: "purchase_intent", weight: 0.6 }, { type: "browsing", weight: 0.25 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "flipkart", name: "Flipkart", category: "shopping", logo: "🛒",
    arpu: { na: 0.5, eu: 0.3, apac: 6.0, latam: 0.2, mena: 0.2, row: 0.2 },
    dataTypes: [{ type: "purchase_intent", weight: 0.6 }, { type: "browsing", weight: 0.25 }, { type: "location", weight: 0.1 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "noon", name: "Noon", category: "shopping", logo: "🌙",
  ...
  {
    id: "spotify", name: "Spotify", category: "streaming", logo: "🎧",
  ...
  {
    id: "disney", name: "Disney+", category: "streaming", logo: "🏰",
    arpu: { na: 5.0, eu: 3.0, apac: 1.0, latam: 0.8, mena: 0.7, row: 0.5 },
    dataTypes: [{ type: "browsing", weight: 0.5 }, { type: "purchase_intent", weight: 0.25 }, { type: "social_graph", weight: 0.15 }, { type: "location", weight: 0.1 }],
  },
  {
    id: "applemusic", name: "Apple Music", category: "streaming", logo: "🎵",
    arpu: { na: 4.0, eu: 2.5, apac: 1.0, latam: 0.6, mena: 0.5, row: 0.4 },
    dataTypes: [{ type: "browsing", weight: 0.5 }, { type: "purchase_intent", weight: 0.25 }, { type: "social_graph", weight: 0.15 }, { type: "location", weight: 0.1 }],
  },
  {
    id: "primevideo", name: "Prime Video", category: "streaming", logo: "🎞️",
  ...
  // ═══ Productivity ═══
  {
    id: "google", name: "Google", category: "productivity", logo: "🔍",
  ...
  {
    id: "microsoft", name: "Microsoft 365", category: "productivity", logo: "🪟",
  ...
  {
    id: "notion", name: "Notion", category: "productivity", logo: "📝",
  ...
  {
    id: "slack", name: "Slack", category: "productivity", logo: "💬",
  ...
  // ═══ Delivery & Ride-hail ═══
  {
    id: "uber", name: "Uber", category: "delivery", logo: "🚗",
  ...
  {
    id: "doordash", name: "DoorDash", category: "delivery", logo: "🍔",
  ...
  {
    id: "grab", name: "Grab", category: "delivery", logo: "🟢",
  ...
  {
    id: "rappi", name: "Rappi", category: "delivery", logo: "🧡",
    arpu: { na: 1.0, eu: 0.3, apac: 0.3, latam: 8.0, mena: 0.3, row: 0.2 },
    dataTypes: [{ type: "purchase_intent", weight: 0.45 }, { type: "location", weight: 0.35 }, { type: "browsing", weight: 0.15 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "instacart", name: "Instacart", category: "delivery", logo: "🥕",
  ...
  {
    id: "deliveroo", name: "Deliveroo", category: "delivery", logo: "🦘",
    arpu: { na: 1.0, eu: 10.0, apac: 3.0, latam: 0.3, mena: 4.0, row: 0.3 },
    dataTypes: [{ type: "purchase_intent", weight: 0.45 }, { type: "location", weight: 0.35 }, { type: "browsing", weight: 0.15 }, { type: "social_graph", weight: 0.05 }],
  },
  {
    id: "talabat", name: "Talabat", category: "delivery", logo: "🧆",
  ...
  // ═══ Dating ═══
  {
    id: "tinder", name: "Tinder", category: "dating", logo: "🔥",
  ...
  {
    id: "bumble", name: "Bumble", category: "dating", logo: "🐝",
    arpu: { na: 12.0, eu: 6.0, apac: 1.5, latam: 1.0, mena: 1.5, row: 0.8 },
    dataTypes: [{ type: "location", weight: 0.35 }, { type: "social_graph", weight: 0.3 }, { type: "browsing", weight: 0.2 }, { type: "purchase_intent", weight: 0.15 }],
  },
  {
    id: "hinge", name: "Hinge", category: "dating", logo: "💜",
  ...
  // ═══ Finance ═══
  {
    id: "paypal", name: "PayPal", category: "finance", logo: "💳",
  ...
  {
    id: "venmo", name: "Venmo", category: "finance", logo: "💸",
  ...
  {
    id: "cashapp", name: "Cash App", category: "finance", logo: "💵",
  ...
  {
    id: "revolut", name: "Revolut", category: "finance", logo: "🏦",
  ...
  {
    id: "wise", name: "Wise", category: "finance", logo: "🌐",
  ...
  // ═══ Health & Fitness ═══
  {
    id: "strava", name: "Strava", category: "health", logo: "🏃",
  ...
  {
    id: "myfitnesspal", name: "MyFitnessPal", category: "health", logo: "💪",
  ...
  {
    id: "peloton", name: "Peloton", category: "health", logo: "🚴",
